...
static const Key keys[] = {
	...
	{ MODKEY,			XK_minus,	spawn,		SHCMD("wpctl set-volume -l 0.99 @DEFAULT_AUDIO_SINK@ 3%-; v=$(wpctl get-volume @DEFAULT_SINK@); v=${v#*.}; dunstify -a Volume -u low -r 9993 -h int:value:${v} -i $PIX/volume-on.svg Volume ${v}% -t 2000") },
	{ MODKEY|ShiftMask,		XK_minus,	spawn,		SHCMD("wpctl set-volume -l 0.99 @DEFAULT_AUDIO_SINK@ 15%-; v=$(wpctl get-volume @DEFAULT_SINK@); v=${v#*.}; dunstify -a Volume -u low -r 9993 -h int:value:${v} -i $PIX/volume-on.svg Volume ${v}% -t 2000") },
	{ MODKEY,			XK_equal,	spawn,		SHCMD("wpctl set-volume -l 0.99 @DEFAULT_AUDIO_SINK@ 3%+; v=$(wpctl get-volume @DEFAULT_SINK@); v=${v#*.}; dunstify -a Volume -u low -r 9993 -h int:value:${v} -i $PIX/volume-on.svg Volume ${v}% -t 2000") },
