...
static const Key keys[] = {
	...
	{ 0, XF86XK_MonBrightnessUp,	spawn,		SHCMD("brightnessctl -e4 set 5%+; b=$(brightnessctl -e4 -m); brightnessctl -e4 set 5%+; b=$(brightnessctl -e4 -m); b=${b#*,*,*,}; dunstify -a Backlight -u low -r 9994 -h int:value:${b%%%,*} -i $PIX/brightness.svg Brightness ${b%%,*} -t 1000") },
	{ 0, XF86XK_MonBrightnessDown,	spawn,		SHCMD("brightnessctl -e4 set 5%-; b=$(brightnessctl -e4 -m); brightnessctl -e4 set 5%+; b=$(brightnessctl -e4 -m); b=${b#*,*,*,}; dunstify -a Backlight -u low -r 9994 -h int:value:${b%%%,*} -i $PIX/brightness.svg Brightness ${b%%,*} -t 1000") },
